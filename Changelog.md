...
- Fixed buildchain to correctly populate POT file. Replaced `intltool-extract` 
  ...
  explicit list of all translatable source files. Provided first translation
  (French). Updated test procedure accordingly. Wrapped missing strings in 
  'i18n.tr()' calls, re-generated POT file and merged new strings in French PO
  file. See Github 

...
- [ ] fix indentation issue in `ratatoskr/shareplugin/Main.qml` starting at line
  that contains:
...
- [ ] remove from `ratatoskr/shareplugin/Main.qml` those debugging messages 
  that do not bring real value

- [ ] for the time being, remove completely the "file preview" feature to get
